...
void BinarySearchTree::insert(BinaryNode*& r, const string& x) {
    if (r == NULL){
    	count++;
...
string BinarySearchTree::pathTo(BinaryNode* r, string rslt, const string& x) const{
...
bool BinarySearchTree::find(BinaryNode* r,const string& x) const{
